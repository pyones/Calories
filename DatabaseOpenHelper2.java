...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
	...
	public static final String COL_CALCON= "CaloriesConsumed";
	///WorkDaily
	...
	// Food Database creation sql statement
	...
	// Work Database creation sql statement
	...
	private static final String DATABASE_CREATE_D = 
			"create table " +
					...
					COL_WORK +  " text not null, " + 
					COL_CALBURN + " text not null, " +
					COL_RESULT + " text not null " +
					");";
	///Calories Eat Count
	private static final String DATABASE_CREATE_C = 
			"create table " +
					TABLE_NAME4 + 
					"(" + 
					COLUMN_ID4 + " integer primary key autoincrement, " + 
					COL_DATE2 + " text not null, "+ 
					COL_TYPE +  " text not null, " + 
					COL_EATEN + " text not null, " +
					COL_CALCON + " text not null " +
					");";
	...
	public void addRowDaily(String date, String work, String calburn,String result)
	{
		DB = this.getReadableDatabase();
		// this is a key value pair holder used by android's SQLite functions
		ContentValues values = new ContentValues();
		...
		values.put(COL_CALBURN,calburn);
	...
	public void deleteRowDaily(String work)
	{
		DB = this.getReadableDatabase();
		// ask the database manager to delete the row of given id
		try
		{
			DB.delete(TABLE_NAME2, COL_WORK + "=" + "'" + work + "'", null);
		}
		catch (Exception e)
		{
			Log.e("DB ERROR", e.toString());
	...
	///Calories
	public void addRowCalorie(String date, String type, String eat, String calorie)
	{
		DB = this.getReadableDatabase();
		// this is a key value pair holder used by android's SQLite functions
		ContentValues values = new ContentValues();
